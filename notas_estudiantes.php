                        ...
                        <table class="table align-middle ">
                            ...
                            <tbody>
                                ...
                                <?php           
                                    ...
                                    $alumnos = ConseguirNotas($db, $id_alumno, $pensum, $periodo);
                                    if (!empty($alumnos)):
                                    ...
                                    <tr class="">
                                        ...
                                        $sql = "select nota from notas where id_alumno = $id_alumno and id_pensum = $pensum and lapso = $lapso and periodo = '$periodo'";
